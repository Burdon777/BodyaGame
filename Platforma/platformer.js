(function() { // module pattern
  ...
  var MAP      = { tw: 64, th: 48 },
      TILE     = 32,
      METER    = TILE,
      GRAVITY  = 9.8 * 6, // стандарт гравитация
      MAXDX    = 30,      // Горизонтальная скорость (15 tiles в сек)
      MAXDY    = 60,      // Вертикальная скорость   (60 tiles в сек)
      ACCEL    = 1/2,     // default take 1/2 second to reach maxdx (horizontal acceleration)
      FRICTION = 1/6,     // default take 1/6 second to stop from maxdx (horizontal friction)
      IMPULSE  = 1600,    // default player jump impulse
      COLOR    = { BLACK: '#98FB98', YELLOW: '#A52A2A', BRICK: '#F5F5F5', PINK: '#6495ED', PURPLE: '#87CEEB', GREY: '#778899', SLATE: '#00FFFF', GOLD: 'gold' },
      COLORS   = [ COLOR.YELLOW, COLOR.BRICK, COLOR.PINK, COLOR.PURPLE, COLOR.GREY ],
      KEY      = { SPACE: 87, LEFT: 65, UP: 38, RIGHT: 68, DOWN: 40 };
  ...
  var counter = 0, dt = 0, now,
      last = timestamp(),
      fpsmeter = new FPSMeter({ decimals: 0, graph: true, theme: 'dark', left: '100px' });
